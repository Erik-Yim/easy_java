...
/**
 * Created by Erik_Yim on 2017/5/27.
 */
public class ByteBufferDemoTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RandomAccessFile  aFile  = new RandomAccessFile("E:/买车注意.txt","rw");
        ...
        while ((bytesRead != -1)) {
            ...
            while (buffer.hasRemaining()) {
                ...
                buffer.get();
                System.out.println(new String(buffer.array(), 0, bytesRead, "GBK"));
            }
